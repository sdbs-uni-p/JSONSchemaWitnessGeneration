...
source('config.r')
df <- read.csv('data/issta/clean_data.csv')
df_timeout <- read.csv('data/issta/timeout.csv')
...
ggsave(paste("output/hexplot_and_histograms_issta_timeout_fix",file_ending,sep=""), plot=plot, height=5, width=8.5, device=cairo_pdf)
