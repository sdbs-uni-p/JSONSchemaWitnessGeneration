...
source('config.r')
df <- read.csv('data/allOf_containment/clean_data.csv')
df_timeout <- read.csv('data/allOf_containment/timeout.csv')
...
ggsave(paste("output/hexplot_and_histograms_allOf_containment_fix",file_ending,sep=""), plot=plot, height=5, width=8.5, device=cairo_pdf)
