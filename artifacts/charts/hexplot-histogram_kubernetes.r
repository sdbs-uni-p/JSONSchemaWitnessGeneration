...
df_timeout <- read.csv('data/kubernetes/timeout.csv')
...
ggsave(paste("output/hexplot_and_histograms_kubernetes_fix",file_ending,sep=""), plot=plot, height=5, width=8.5, device=cairo_pdf)
