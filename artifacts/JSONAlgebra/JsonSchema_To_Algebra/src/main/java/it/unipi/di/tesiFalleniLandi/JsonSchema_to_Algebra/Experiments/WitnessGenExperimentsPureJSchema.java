...
public class WitnessGenExperimentsPureJSchema {
	...
	public static void main(String[] args) throws IOException {
		...
		WitnessGenExperimentsPureJSchema obj = new WitnessGenExperimentsPureJSchema();
		...
		String path =  "C:\\Users\\ghell\\OneDrive - University of Pisa\\GitHubNew2\\JSONAlgebra\\JsonSchema_To_Algebra\\witnessGenTestfiles\\NPproblems" ;      //  args[0];
...
//			System.out.println(file+ " ---- "+i);
	...
	private StringBuilder getRow(WitnessGenExperimentsPureJSchema obj) {
