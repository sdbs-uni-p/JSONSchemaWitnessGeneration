...
public class GenerateWitnessTaskV2 implements Callable<Boolean> {
...
//    boolean processed=false; // Flag to check if the task ended (used to split the files into processed/unprocessed files)
    ...
    // Constructor
    public GenerateWitnessTaskV2(File inputSchema) throws IOException {
    ...
    public Boolean call() throws IOException {
        ...
        do
        {
            ...
            try {
                ...
                putDuration(this.currentOperation,end - start);
                this.resultMap.put(Utils.outSize,String.valueOf(witnessEnv.getFullAlgebra().toGrammarString().length()));
                this.resultMap.put(Utils.dnfSize,String.valueOf(witnessEnv.getFullAlgebra().toGrammarString().length()));
                this.sizeMap.put(Utils.dnf,String.valueOf(witnessEnv.getFullAlgebra().toGrammarString().length()));
            } catch (Exception e) {
            ...
            try {
                ...
                putDuration(this.currentOperation,end - start);
                this.resultMap.put(Utils.outSize,String.valueOf(witnessEnv.getFullAlgebra().toGrammarString().length()));
                this.sizeMap.put(Utils.arrPrep,String.valueOf(witnessEnv.getFullAlgebra().toGrammarString().length()));
            } catch (Exception re) {
